...
const ModalLayout = ({ children }: ModalLayoutProps) => {
	...
	return (
		<AnimatePresence>
			...
			>
				<div
					className='bg-card-light dark:bg-card-dark p-8 rounded-lg relative max-w-2xl w-screen max-h-[100svh] md:max-h-[90svh] top-0 left-0 overflow-y-scroll scrollbar-hide'
