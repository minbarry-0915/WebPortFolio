		...
		<>
			...
			>
				<div id='description' className='flex flex-col gap-1.5'>
					<div className='font-extralight text-secondary dark:text-secondary-dark'>
						프로젝트 설명
					</div>
					<div className='break-keep'>{project.description}</div>
				</div>
				...
				<div className='flex flex-wrap gap-6'>
					<div id='member' className='flex flex-col gap-1.5'>
						...
						<div className='text-base'>{data.member}</div>
					</div>
							...
							{data.links?.map(
								(link: { label: string; url: string }, index: number) => (
									<Link
										...
										className='text-secondary dark:text-secondary-dark hover:text-foreground underline underline-offset-4'
									>
										{link.label}
									</Link>
								)
			...
			<div id='body' className='flex flex-col gap-12 sm:text-base text-sm'>
				<div id='overview' className='flex flex-col'>
					...
					<div className='flex flex-col gap-1 text-secondary dark:text-secondary-dark font-extralight'>
