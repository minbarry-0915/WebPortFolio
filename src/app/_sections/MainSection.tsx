const MainSection = () => {
	return (
		...
		>
			<h1 className='font-bold text-5xl md:text-6xl text-center leading-tight md:leading-[4rem] break-keep'>
				안녕하세요,
				<br />
				프론트엔드 개발자
				<br />
			...
			<p className='font-medium text-2xl text-center leading-[2.25rem] '>
